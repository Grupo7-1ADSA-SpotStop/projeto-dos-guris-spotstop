...
('06.057.223/0001-71', 'assai@outlook.com', '2345678901', 'Hipermercado Assaí', 'Marco Antônio', 'Av. Aricanduva, 5555 - Jardim Marília, São Paulo - SP, 03527-900'),
('45.543.915/0015-87', 'carrefour@gmail.com', '3456789012', 'Hipermercado Carrefour', 'Alexandre Bompard', ' R. George Eastman, 213 - Vila Tramontano, São Paulo - SP, 05690-000');
...
select * from cadastroCliente where nomeEmpresa like 'Shopping%';
select * from cadastroCliente where nomeEmpresa like '%Mercado%';
